<template>
  <template v-if="entry">
    <div class="entry-title d-flex justify-content-between p-2">
      ...
      <div>
        ...
        <input v-show="false" ref="imageSelector" @change="onSelectedImage" type="file" accept="image/png, image/jpeg">

        <button @click="onSelectImage" class="btn btn-info mx-2">
          Subir Foto
  ...
  <Fab @on:click="saveEntry" icon="fi-rr-disk"/>
